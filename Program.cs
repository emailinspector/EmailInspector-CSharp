...
namespace ConsoleApplication1
{
    class Program
    {
        ...
        public static void verifyByOne()
        {
            ...
            string sURL = "https://app.emailinspector.io/api/verifEmail?secret=" + key + "&email=" + email;
            WebRequest wrGETURL;
        ...
        {
            string key = "PUT YOUR KEY HERE";
            string sURL = "https://app.emailinspector.io/api/getApiFileInfo?secret=" + key + "&id=" + id;
            WebRequest wrGETURL;
            wrGETURL = WebRequest.Create(sURL);
        ...
        static void Main(string[] args)
        {
            ...
            string url = "https://app.emailinspector.io/api/verifApiFile?secret=" + key + "&filename=my_emails.txt";
